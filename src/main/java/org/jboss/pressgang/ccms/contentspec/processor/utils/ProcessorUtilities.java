...
public class ProcessorUtilities {
     ...
     *
     * @param contentSpec The ContentSpec object to create the Post Processed Content Specification for.
     * @param specTopics  A HashMap of the all the Content Specification Topics that can exist in the Content
     ...
     */
    public static String generatePostContentSpec(final ContentSpec contentSpec, final Map<String, SpecTopic> specTopics) {
        ...
        final NamedPattern newTopicRelationshipPattern = NamedPattern.compile("" +
                "(B:|P:|PREREQUISITE:|R:|RELATED-TO:|REFER-TO:|L:|LINK-LIST:|NEXT:|PREV:|," +
                "|\\[)[ ]*(?<" + ProcessorConstants.TOPIC_ID_CONTENTS + ">N[0-9]+)[ ]*" +
                "(?=(,|\\]))");
        final NamedPattern duplicateTopicPattern = NamedPattern.compile("" +
                "(B:|P:|PREREQUISITE:|R:|RELATED-TO:|REFER-TO:|L:|LINK-LIST:|NEXT:|PREV:|," +
                "|\\[)[ ]*(?<" + ProcessorConstants.TOPIC_ID_CONTENTS + ">X[0-9]+)[ ]*" +
                "(?=(,|\\]))");
        final NamedPattern clonedTopicPattern = NamedPattern.compile("" +
                "(B:|P:|PREREQUISITE:|R:|RELATED-TO:|REFER-TO:|L:|LINK-LIST:|NEXT:|PREV:|," +
                "|\\[)[ ]*(?<" + ProcessorConstants.TOPIC_ID_CONTENTS + ">C[0-9]+)[ ]*" +
                "(?=(,|\\]))");
        final NamedPattern clonedDuplicateTopicPattern = NamedPattern.compile("" +
                "(B:|P:|PREREQUISITE:|R:|RELATED-TO:|REFER-TO:|L:|LINK-LIST:|NEXT:|PREV:|," +
                "|\\[)[ ]*(?<" + ProcessorConstants.TOPIC_ID_CONTENTS + ">XC[0-9]+)[ ]*" +
                "(?=(,|\\]))");
        int count = 1;
        //if (editing) count += 2;
     ...
     * @param specTopic  The topic that the line to be stripped represents.
